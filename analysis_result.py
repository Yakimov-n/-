...
"""читаем блокчейн"""
dg = pd.read_csv('https://raw.githubusercontent.com/Yakimov-n/transaction-analysis\
/transaction-analysis/btc-tx.csv', sep = ',', encoding='latin1',parse_dates=['time'], dayfirst=True, error_bad_lines=False)
...
db = pd.read_csv('https://raw.githubusercontent.com/Yakimov-n/transaction-analysis/transaction-analysis\
/%D0%9F%D1%80%D0%BE%D1%88%D0%BB%D1%8B%D0%B5%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5%20-%20BTC_USD%20Bitfinex.csv',\
                 sep = ',', parse_dates=['Дата'], dayfirst=True) # читаем статистику по стоимости биткоина
...
df1 = pd.read_csv('https://raw.githubusercontent.com/Yakimov-n/transaction-analysis/transaction-analysis/download_transactions_map.csv',\
                  sep = ',', parse_dates=['begin_date', 'end_date'],dayfirst=True)
...
df1 = df1.loc[flt]
"""выбираем суммы близкие к млн и смотрим, что происходило за одни сутки до и через одни сутки после транзакции"""
