...
"""читаем блокчейн"""
dg = pd.read_html('https://github.com/Yakimov-n/transaction-analysis.git/btc-tx.csv', sep = ',', encoding='latin1',parse_dates=['time'], dayfirst=True, error_bad_lines=False)
...
db = pd.read_html('https://github.com/Yakimov-n/transaction-analysis.git/Прошлые данные - BTC_USD Bitfinex.csv', sep = ',', parse_dates=['Дата'], dayfirst=True) # читаем статистику по стоимости биткоина
...
df1 = pd.read_html('https://github.com/Yakimov-n/transaction-analysis.git/download_transactions_map.csv', sep = ',', parse_dates=['begin_date', 'end_date'],dayfirst=True)
